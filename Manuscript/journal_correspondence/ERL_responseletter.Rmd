...
header-includes:
   ...
   - \usepackage{eso-pic}
   - \usepackage{graphicx}
   - \newcommand\BackgroundPic{\put(0,0){\parbox[b][\paperheight]{\paperwidth}{\vfill\centering \includegraphics[width=\paperwidth,height=\paperheight, keepaspectratio]{usgs_response_letterhead.pdf} \vfill }}}
...
Lots and lots more text, repeating last paragraph of letter here to see what happens on page two. 
