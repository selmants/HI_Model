...
We have added text describing how litter and dead wood pools were initialized using values from the IBIS DGVM (lines 180-181) and allowed to equilibrate with spatially variable NPP using a spinup model (lines 205-210). GeoTIFF raster files of initial carbon stocks are available at https://doi.org/10.5281/zenodo.5198072.    
