...
### *Carbon stocks and flows*
 The fate of continuous carbon stocks was tracked for each simulation cell based on a suite of continuous flows (i.e., carbon fluxes) specifying the rates of change in these carbon stocks over time [@daniel_integrating_2018; @sleeter_effects_2019]. 
