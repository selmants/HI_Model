...
```
Net biome productivity (NBP) averaged approximately 0.6 Tg C y^-1^ at the start of the simulation period and declined under all four scenarios over time (figure 4).  On average, terrestrial ecosystems of the seven main Hawaiian Islands collectively acted as a net carbon sink throughout the simulation period under RCP 4.5, with carbon sink strength ~60% greater in the low land-use scenario than in the high land-use scenaro by the year 2100 (figure 4). In contrast, ecosystems of the Hawaiian Islands became a net carbon source to the atmosphere toward the latter half of the simulation period under RCP 8.5, although the transition from sink to source occured 15 years earlier on average under the high land-use scenario than under the low land-use scenario (figure 4). Net biome productivity was also ~40% more negative under the high land-use scenario by the end of the simulation period. 
...
This study was funded by the Biological Sequestration Program of the U.S. Geological Survey. Thanks to Nicholas Koch of Forest Solutions, Inc. for information on eucalyptus harvesting and to Leonardo Frid and Colin Daniel of ApexRMS for assistance with SyncroSim software. Thanks also to Christian Giardina and Zhiliang Zhu for making this project possible. Any use of trade, firm, or product names is for descriptive purposes only and does not imply endorsement by the U.S. Government.
