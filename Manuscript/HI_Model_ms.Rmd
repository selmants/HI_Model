...
Net primary production (NPP) declined across all four scenarios (Fig. 3). The combination of high radiative forcing (RCP 8.5) and high land-use change led to the steepest decline in NPP over time, driven by intense long-term drying on the leeward sides of islands under RCP 8.5 (Fig. S4) and reduction of forest and shrubland land area in the high land use scenario (Fig. S5). In contrast to NPP, heterotrophic respiration (Rh) was higher under RCP 8.5 than under RCP 4.5 (Fig. 3) because of more intense warming over time (Fig. S4). High land-use change lowered Rh (Fig. 3) because of reduced forest and shrubland land area (Fig. S5), similar to trends in NPP. Carbon fluxes to the atmosphere triggered by land use, land-use change, and fire were largely independent of changes in climate, with greater variability in these fluxes across Monte Carlo iterations in the high land-use scenario (Fig. 3). 
...
Tabular model output data in machine readable format are available from a USGS ScienceBase data repository: https://doi.org/10.5066/P9AWLFKZ. Model input data and R code used to format input data, summarize output data, and compile this manuscript are available from a GitHub repository: https://github.com/selmants/HI_Model. 
